...
/* ATENÇÃO - Este exemplo utiliza apenas um ponteiro de controle  */
/*           (inicio), o ideal seria que existissem 2 ponteiros   */
/*			 para economizar processamento no momento da inserção */
/* PROPOSTA - Realizar alteração considerar 2 ponteiros.          */
